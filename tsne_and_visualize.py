...
parser.add_argument("-m", "--model", help="File name of the pretrained model (located in trained_models/)", default='VDSH_11:04:2020_16:14.model')
...
model.load_state_dict(torch.load('trained_models/' + args.model))
model.eval()
